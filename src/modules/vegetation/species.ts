...
export const SPECIES: SpeciesDef[] = [
  {
    id: 0, name: 'poplar_italica', kind: 'tree', variants: 2, bark: 'willow', barkTint: T(0.95, 0.93, 0.88), leafTint: T(0.95, 1.0, 0.92), translucency: 0.55, roughness: 0.62,
  ...
  {
    id: 1, name: 'poplar_black', kind: 'tree', variants: 2, bark: 'oak', barkTint: T(0.85, 0.82, 0.78), leafTint: T(0.95, 1.0, 0.9), translucency: 0.5, roughness: 0.6,
  ...
  {
    id: 2, name: 'poplar_white', kind: 'tree', bark: 'willow', barkTint: T(1.35, 1.35, 1.3), leafTint: T(1.0, 1.05, 1.0), translucency: 0.5, roughness: 0.7,
  ...
  {
    id: 3, name: 'willow', kind: 'tree', variants: 2, bark: 'willow', barkTint: T(0.85, 0.8, 0.72), leafTint: T(1.0, 1.0, 0.95), translucency: 0.6, roughness: 0.75,
  ...
  {
    id: 4, name: 'robinia', kind: 'tree', variants: 2, bark: 'oak', barkTint: T(0.8, 0.72, 0.62), leafTint: T(1.0, 1.0, 0.92), translucency: 0.65, roughness: 0.7,
  ...
  {
    id: 5, name: 'chestnut', kind: 'tree', bark: 'oak', barkTint: T(0.78, 0.72, 0.66), leafTint: T(0.95, 1.0, 0.9), translucency: 0.4, roughness: 0.6,
  ...
  {
    id: 6, name: 'linden', kind: 'tree', bark: 'willow', barkTint: T(0.8, 0.78, 0.74), leafTint: T(1.0, 1.0, 0.92), translucency: 0.5, roughness: 0.62,
  ...
  {
    id: 7, name: 'maple', kind: 'tree', variants: 2, bark: 'willow', barkTint: T(0.7, 0.68, 0.64), leafTint: T(1.0, 1.0, 0.92), translucency: 0.5, roughness: 0.62,
  ...
  {
    id: 8, name: 'boxelder', kind: 'tree', bark: 'willow', barkTint: T(0.78, 0.76, 0.66), leafTint: T(0.85, 0.95, 0.8), translucency: 0.6, roughness: 0.7,
  ...
  {
    id: 9, name: 'elm', kind: 'tree', variants: 2, bark: 'oak', barkTint: T(0.72, 0.68, 0.62), leafTint: T(0.95, 1.0, 0.92), translucency: 0.5, roughness: 0.7,
  ...
  {
    id: 10, name: 'walnut', kind: 'tree', variants: 2, bark: 'willow', barkTint: T(0.95, 0.93, 0.9), leafTint: T(0.98, 1.0, 0.92), translucency: 0.5, roughness: 0.62,
  ...
  {
    id: 11, name: 'fruit', kind: 'tree', variants: 2, bark: 'oak', barkTint: T(0.72, 0.66, 0.6), leafTint: T(1.0, 1.0, 0.94), translucency: 0.5, roughness: 0.62,
  ...
  {
    id: 12, name: 'cherry', kind: 'tree', bark: 'birch', barkTint: T(0.42, 0.34, 0.32), leafTint: T(0.95, 0.98, 0.9), translucency: 0.5, roughness: 0.55,
  ...
  {
    id: 13, name: 'oak', kind: 'tree', bark: 'oak', barkTint: T(0.85, 0.8, 0.74), leafTint: T(0.95, 1.0, 0.9), translucency: 0.4, roughness: 0.68,
  ...
  {
    id: 14, name: 'ash', kind: 'tree', bark: 'willow', barkTint: T(0.85, 0.84, 0.8), leafTint: T(0.9, 0.98, 0.86), translucency: 0.6, roughness: 0.66,
  ...
  {
    id: 15, name: 'birch', kind: 'tree', bark: 'birch', barkTint: T(1.0, 1.0, 1.0), leafTint: T(1.0, 1.0, 0.92), translucency: 0.65, roughness: 0.6,
  ...
  {
    id: 16, name: 'pine', kind: 'tree', bark: 'pine', barkTint: T(0.95, 0.85, 0.78), leafTint: T(0.95, 1.0, 0.95), translucency: 0.3, roughness: 0.7,
  ...
  {
    id: 17, name: 'spruce', kind: 'tree', bark: 'pine', barkTint: T(0.7, 0.62, 0.58), leafTint: T(0.78, 0.9, 0.84), translucency: 0.25, roughness: 0.7,
  ...
  {
    id: 18, name: 'thuja', kind: 'tree', bark: 'pine', barkTint: T(0.7, 0.55, 0.45), leafTint: T(1.0, 1.0, 0.95), translucency: 0.3, roughness: 0.7,
  ...
  {
    id: 19, name: 'alder', kind: 'tree', bark: 'willow', barkTint: T(0.6, 0.58, 0.55), leafTint: T(0.85, 0.95, 0.85), translucency: 0.45, roughness: 0.62,
  ...
  // ------------------------------------------------ shrubs
  {
    id: 32, name: 'lilac', kind: 'shrub', bark: 'willow', barkTint: T(0.6, 0.58, 0.55), leafTint: T(1.0, 1.0, 0.95), translucency: 0.5, roughness: 0.6,
  ...
  {
    id: 33, name: 'shrub', kind: 'shrub', bark: 'oak', barkTint: T(0.6, 0.55, 0.5), leafTint: T(0.95, 1.0, 0.9), translucency: 0.5, roughness: 0.65,
  ...
  {
    id: 34, name: 'rose', kind: 'shrub', bark: 'oak', barkTint: T(0.55, 0.45, 0.4), leafTint: T(0.9, 0.95, 0.85), translucency: 0.45, roughness: 0.65,
  ...
  {
    id: 35, name: 'willow_shrub', kind: 'shrub', bark: 'willow', barkTint: T(0.65, 0.55, 0.45), leafTint: T(1.0, 1.0, 0.95), translucency: 0.6, roughness: 0.75,
  ...
  {
    id: 36, name: 'hedge', kind: 'hedge', bark: 'oak', barkTint: T(0.6, 0.55, 0.5), leafTint: T(0.9, 0.97, 0.85), translucency: 0.35, roughness: 0.7,
    gen: { kind: 'hedge', seed: 205, height: 1.1, crown: 0.9, trunkRadius: 0, leafSize: 0.42, leafDensity: 1, leafCell: C.elm },
  },
  {
    id: 37, name: 'juniper', kind: 'shrub', bark: 'pine', barkTint: T(0.6, 0.5, 0.42), leafTint: T(0.85, 0.95, 0.9), translucency: 0.25, roughness: 0.75,
