...
export const SPECIES: SpeciesDef[] = [
  {
    id: 0, name: 'poplar_italica', kind: 'tree', bark: 'willow', barkTint: T(0.95, 0.93, 0.88), leafTint: T(0.95, 1.0, 0.92), translucency: 0.55, roughness: 0.62,
  ...
  {
    id: 1, name: 'poplar_black', kind: 'tree', bark: 'oak', barkTint: T(0.85, 0.82, 0.78), leafTint: T(0.95, 1.0, 0.9), translucency: 0.5, roughness: 0.6,
  ...
  {
    id: 3, name: 'willow', kind: 'tree', bark: 'willow', barkTint: T(0.85, 0.8, 0.72), leafTint: T(1.0, 1.0, 0.95), translucency: 0.6, roughness: 0.75,
  ...
  {
    id: 4, name: 'robinia', kind: 'tree', bark: 'oak', barkTint: T(0.8, 0.72, 0.62), leafTint: T(1.0, 1.0, 0.92), translucency: 0.65, roughness: 0.7,
  ...
  {
    id: 7, name: 'maple', kind: 'tree', bark: 'willow', barkTint: T(0.7, 0.68, 0.64), leafTint: T(1.0, 1.0, 0.92), translucency: 0.5, roughness: 0.62,
  ...
  {
    id: 9, name: 'elm', kind: 'tree', bark: 'oak', barkTint: T(0.72, 0.68, 0.62), leafTint: T(0.95, 1.0, 0.92), translucency: 0.5, roughness: 0.7,
  ...
  {
    id: 10, name: 'walnut', kind: 'tree', bark: 'willow', barkTint: T(0.95, 0.93, 0.9), leafTint: T(0.98, 1.0, 0.92), translucency: 0.5, roughness: 0.62,
  ...
  {
    id: 11, name: 'fruit', kind: 'tree', bark: 'oak', barkTint: T(0.72, 0.66, 0.6), leafTint: T(1.0, 1.0, 0.94), translucency: 0.5, roughness: 0.62,
  ...
  {
    id: 17, name: 'spruce', kind: 'tree', bark: 'pine', barkTint: T(0.7, 0.62, 0.58), leafTint: T(0.95, 1.0, 1.0), translucency: 0.25, roughness: 0.7,
